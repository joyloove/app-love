...
1. Replicar el maquetado de AppLove
1.1 Complatar el README.md
2. Usar la carpeta clonada para realizar la replica visual
3. Completar el index.HTML
4. Completar el CSS
5. Usar id y clases
6. Dar estilo al texto, imágenes y contenido
